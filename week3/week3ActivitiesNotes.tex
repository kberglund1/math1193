...
\begin{enumerate}
    \item Rewrite the first equation in terms of \(b\). That is, rewrite it so no terms contain an \(a\).
    \item Rewrite the second equation in terms of \(a\). That is, rewrite it so no terms contain an \(b\).
\end{enumerate}
\end{problem}
